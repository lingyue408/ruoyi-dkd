<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="regionId">
        <el-input
      ...
      <el-form-item label="${comment}" prop="partnerId">
        <el-input
    ...
    <el-table v-loading="loading" :data="nodeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="regionId" />
      <el-table-column label="${comment}" align="center" prop="partnerId" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="nodeRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="regionId">
          <el-input v-model="form.regionId" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="partnerId">
          <el-input v-model="form.partnerId" placeholder="请输入${comment}" />
        </el-form-item>
      </el-form>
      <template #footer>
